...
def _validate_env():
    """Log warnings for missing critical env vars on startup."""
    warnings = []
...
def hash_password(pw, salt=None):
    """PBKDF2-HMAC-SHA256 with per-user salt. Backwards-compatible with old SHA256."""
...
def verify_password(pw, stored):
    """Verify password against stored hash — handles both old SHA256 and new PBKDF2."""
    import hashlib
